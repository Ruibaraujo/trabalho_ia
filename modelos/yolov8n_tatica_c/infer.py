...
Uso:
    python inferencia.py --model path/to/best.pt --image path/to/image.jpg
    python inferencia.py --model path/to/best.pt --input path/to/folder/ --output path/to/results/
    python inferencia.py --model path/to/best.pt --image path/to/image.jpg --conf 0.828 --iou 0.70
"""
