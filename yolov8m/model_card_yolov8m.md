...
- **Metrics (Métricas Reais Consolidadas das Curvas do YOLOv8m — conjunto de teste):**
  - **Macro-Métricas Globais (All Classes):**
    - `Precision (Macro)`: 1.00 (@ confidence 0.978)
